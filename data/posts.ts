...
export const posts: Post[] = [
  ...
  {
    slug: "juguetes-matematicas-ninos-guia-2025",
    image: "/images/blog/juguetes-matematicas-ninos-guia-2025.jpg",
    title: "Juguetes para aprender matemáticas jugando: guía por edad (2025)",
    excerpt: "Qué juguetes trabajan de verdad el pensamiento matemático por edad: de la Torre Rosa Montessori sensorial a los juegos de mesa con cálculo de recursos y geometría rápida.",
    category: "Guías",
    date: "2026-08-29",
    readTime: 8,
    relatedProducts: ["torre-rosa-montessori-10-cubos-madera", "geomag-classic-color-91-piezas", "ubongo-junior-asmodee-puzzle-rapido", "catan-junior-devir-6-anos"],
    relatedPosts: ["como-elegir-juguete-educativo", "pensamiento-critico-ninos-juegos", "juguetes-educativos-6-anos"],
    categoryCta: { href: "/tienda/juguetes-montessori", text: "Ver material matemático →" },
  },
  {
    slug: "juguetes-energia-solar-renovable-ninos-guia-2026",
    image: "/images/blog/juguetes-energia-solar-renovable-ninos-guia-2026.jpg",
    title: "Juguetes de energía solar para niños: guía de kits STEM renovables (2026)",
    excerpt: "Los kits de robótica solar enseñan energías renovables construyendo, no memorizando. Comparamos un kit solar 12 en 1 con la robótica STEM clásica (Snap Circuits, LEGO Boost) y explicamos cuándo tiene sentido cada uno.",
    category: "STEM",
    date: "2026-09-04",
    readTime: 7,
    relatedProducts: ["acelife-robot-solar-12en1-kit-stem", "snap-circuits-jr-sc-100-electronica-ninos", "lego-boost-creative-toolbox-17101-robotica"],
    relatedPosts: ["introduccion-programacion-ninos", "robotica-ninos-primeros-pasos", "juguetes-stem-ninos-8-anos"],
    categoryCta: { href: "/tienda/juguetes-stem", text: "Ver kits de robótica →" },
  },
  {
    slug: "quickstop-analisis-opinion",
    image: "/images/blog/quickstop-analisis-opinion.jpg",
    title: "QuickStop: análisis completo y opiniones 2026",
    excerpt: "Análisis del juego de mesa QuickStop, ganador del Gran Premio del Juguete 2024: mecánica de reflejos, para cuántos jugadores funciona mejor y si merece la pena frente a otros juegos familiares del catálogo.",
    category: "Juegos de Mesa",
    date: "2026-09-07",
    readTime: 6,
    relatedProducts: ["quickstop-juego-mesa-familiar-reflejos", "dobble-juego-cartas-asmodee-velocidad-atencion", "conecta-4-hasbro-juego-estrategia-logica"],
    relatedPosts: ["mejores-juegos-mesa-familia", "juegos-mesa-educativos-primaria", "juegos-cartas-educativos-familia"],
    categoryCta: { href: "/tienda/juegos-mesa-educativos", text: "Ver juegos de mesa educativos →" },
  },
  {
    slug: "geosafari-jr-kidnoculars-analisis",
    image: "/images/blog/geosafari-jr-kidnoculars-analisis.jpg",
    title: "GeoSafari Jr Kidnoculars de Learning Resources: análisis completo 2026",
    excerpt: "Por qué los prismáticos infantiles GeoSafari Jr Kidnoculars acumulan casi 24.000 valoraciones en Amazon.es: diseño sin enfoque, edad recomendada real y si son el primer instrumento óptico adecuado antes de un telescopio o microscopio.",
    category: "Telescopios y Microscopios",
    date: "2026-09-07",
    readTime: 6,
    relatedProducts: ["learning-resources-geosafari-jr-kidnoculars", "kizplays-kit-explorador-naturaleza-22-piezas", "telescopio-astronomico-ninos-8-12-anos-tripode"],
    relatedPosts: ["mejor-telescopio-ninos-principiantes-2025", "microscopio-ninos-guia-compra", "juguetes-0-2-anos-desarrollo"],
    categoryCta: { href: "/tienda/telescopios-microscopios", text: "Ver telescopios y microscopios →" },
  },
];
